...
- Name: handsonExercise/tc04login.spec.ts >> Verify that a new dependent can be added. 
            ...
            - generic [ref=f2e190]:
              ...
              - generic [ref=f2e204]:
                ...
                - generic [ref=f2e212]:
                  ...
                  - generic [ref=f2e217]:
                    - textbox "yyyy-dd-mm" [ref=f2e218]: 2030-31-12
...
```ts
  ...
  11 | 
  12 | test ('Verify that a new dependent can be added. ', async({page}) => {
...
> 18 | await page.click('a[href="/web/index.php/pim/viewDependents"]'); // Click on "Dependents" subtab
     |            ^ Error: page.click: Test timeout of 30000ms exceeded.
  19 | await page.click('button[type="button"]:has-text("Add")'); // Click "Add" button
  20 | await page.fill('input[name="name"]', 'DependentName'); // Enter dependent name
  21 | await page.selectOption('select[name="relationship"]', 'other'); // Select "Other" as relationship
  22 | await page.fill('input[name="relationship"]', 'SpecifiedRelationship'); // Specify the relationship
  23 | await page.click('button[type="submit"]'); // Click "Save"
  24 | 
  25 | await page.click('button[type="button"]:has-text("Edit")'); // Click "Edit" button for the dependent
  26 | await page.fill('input[name="name"]', 'UpdatedDependentName'); // Update dependent name
  27 | await page.click('button[type="submit"]'); // Click "Save"  
  28 | await page.getByText('Successfully Updated').waitFor(); // Wait for save confirmation toast
  29 | 
  30 | await page.click('button[type="button"]:has-text("Add")'); // Click "Add" button in Attachments section
  31 | await page.setInputFiles('input[type="file"]', '/Users/rameshbalasubramanian/PlaywrightAutomation/Samplefileupload.rtf'); // Upload sample PDF
  32 | await page.click('button[type="submit"]'); // Click "Save" for attachment
  33 | await page.getByText('Successfully Uploaded').waitFor(); // Wait for upload confirmation toast
  34 | 
  35 | });
```