...
Call log:
  - waiting for getByRole('button', { name: 'Save' }).last().getByText('Successfully Uploaded') to be visible
    ...
    - generic [ref=f3e139]:
      ...
      - generic [ref=f3e168]:
        ...
        - generic [ref=f3e174]:
          ...
          - generic [ref=f3e176]: (17) Records Found
        - table [ref=f3e179]:
          - rowgroup [ref=f3e180]:
            - row [ref=f3e181]:
        ...
        - generic [ref=f3e534]:
          - separator [ref=f3e535]
          - generic [ref=f3e537]:
            - heading "Attachments" [level=6] [ref=f3e538]
            - button " Add" [ref=f3e539] [cursor=pointer]:
              - generic [ref=f3e540]: 
              - text: Add
          - generic [ref=f3e541]:
            - separator [ref=f3e542]
            - generic [ref=f3e543]: (2) Records Found
          - table [ref=f3e546]:
            - rowgroup [ref=f3e547]:
              - row [ref=f3e548]:
                - columnheader "" [ref=f3e549]:
                  - generic [ref=f3e551] [cursor=pointer]:
                    - checkbox "" [ref=f3e552]
                    - generic [ref=f3e553]: 
                - columnheader "File Name" [ref=f3e555]
                - columnheader "Description" [ref=f3e556]
                - columnheader "Size" [ref=f3e557]
                - columnheader "Type" [ref=f3e558]
                - columnheader "Date Added" [ref=f3e559]
                - columnheader "Added By" [ref=f3e560]
                - columnheader "Actions" [ref=f3e561]
            - rowgroup [ref=f3e562]:
              - row [ref=f3e564]:
                - cell "" [ref=f3e565]:
                  - generic [ref=f3e568] [cursor=pointer]:
                    - checkbox "" [ref=f3e569]
                    - generic [ref=f3e570]: 
                - cell "Samplefileupload.rtf" [ref=f3e572]
                - cell [ref=f3e574]
                - cell "381.00 B" [ref=f3e575]
                - cell "text/rtf" [ref=f3e577]
                - cell "2026-19-09" [ref=f3e579]
                - cell "Admin" [ref=f3e581]
                - cell [ref=f3e583]:
                  - generic [ref=f3e584]:
                    - button "" [ref=f3e585] [cursor=pointer]
                    - button "" [ref=f3e587] [cursor=pointer]
                    - button "" [ref=f3e589] [cursor=pointer]
              - row [ref=f3e592]:
                - cell "" [ref=f3e593]:
                  - generic [ref=f3e596] [cursor=pointer]:
                    - checkbox "" [ref=f3e597]
                    - generic [ref=f3e598]: 
                - cell "Samplefileupload.rtf" [ref=f3e600]
                - cell [ref=f3e602]
                - cell "381.00 B" [ref=f3e603]
                - cell "text/rtf" [ref=f3e605]
                - cell "2026-19-09" [ref=f3e607]
                - cell "Admin" [ref=f3e609]
                - cell [ref=f3e611]:
                  - generic [ref=f3e612]:
                    - button "" [ref=f3e613] [cursor=pointer]
                    - button "" [ref=f3e615] [cursor=pointer]
                    - button "" [ref=f3e617] [cursor=pointer]
    - generic [ref=f3e619]:
      - paragraph [ref=f3e620]: OrangeHRM OS 5.9
      - paragraph [ref=f3e621]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f3e622] [cursor=pointer]:
...
```ts
  ...
  85 | 
> 86 | await saveButton.getByText('Successfully Uploaded').waitFor(); // Wait for upload confirmation toast
     |                                                     ^ Error: locator.waitFor: Test timeout of 30000ms exceeded.
  87 | 
  88 | });
```