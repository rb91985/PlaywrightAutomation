    ...
    - generic [ref=f3e139]:
      - generic [ref=f3e140]:
        - generic [ref=f3e141]:
          - generic:
            - heading [level=6]
          - generic [ref=f3e143] [cursor=pointer]:
            - img "profile picture"
        - tablist [ref=f3e144]:
          - tab [ref=f3e145]:
            - link "Personal Details" [ref=f3e146] [cursor=pointer]:
              - /url: /web/index.php/pim/viewPersonalDetails/empNumber/7
          - tab [ref=f3e147]:
            - link "Contact Details" [ref=f3e148] [cursor=pointer]:
              - /url: /web/index.php/pim/contactDetails/empNumber/7
          - tab [ref=f3e149]:
            - link "Emergency Contacts" [ref=f3e150] [cursor=pointer]:
              - /url: /web/index.php/pim/viewEmergencyContacts/empNumber/7
          - tab [ref=f3e151]:
            - link "Dependents" [ref=f3e152] [cursor=pointer]:
              - /url: /web/index.php/pim/viewDependents/empNumber/7
          - tab [ref=f3e153]:
            - link "Immigration" [ref=f3e154] [cursor=pointer]:
              - /url: /web/index.php/pim/viewImmigration/empNumber/7
          - tab [ref=f3e155]:
            - link "Job" [ref=f3e156] [cursor=pointer]:
              - /url: /web/index.php/pim/viewJobDetails/empNumber/7
          - tab [ref=f3e157]:
            - link "Salary" [ref=f3e158] [cursor=pointer]:
              - /url: /web/index.php/pim/viewSalaryList/empNumber/7
          - tab [ref=f3e159]:
            - link "Report-to" [ref=f3e160] [cursor=pointer]:
              - /url: /web/index.php/pim/viewReportToDetails/empNumber/7
          - tab [ref=f3e161]:
            - link "Qualifications" [ref=f3e162] [cursor=pointer]:
              - /url: /web/index.php/pim/viewQualifications/empNumber/7
          - tab [ref=f3e163]:
            - link "Memberships" [ref=f3e164] [cursor=pointer]:
              - /url: /web/index.php/pim/viewMemberships/empNumber/7
      - generic [ref=f3e165]:
        - generic [ref=f3e166]:
          - heading "Personal Details" [level=6] [ref=f3e167]
          - separator [ref=f3e168]
          - generic [ref=f3e169]:
            - generic [ref=f3e176]:
              - generic [ref=f3e177]: Employee Full Name*
              - generic [ref=f3e179]:
                - textbox "First Name" [ref=f3e182]
                - textbox "Middle Name" [ref=f3e185]
                - textbox "Last Name" [ref=f3e188]
            - separator [ref=f3e189]
            - generic [ref=f3e190]:
              - generic [ref=f3e191]:
                - generic [ref=f3e193]:
                  - generic [ref=f3e194]: Employee Id
                  - textbox [ref=f3e197]
                - generic [ref=f3e199]:
                  - generic [ref=f3e200]: Other Id
                  - textbox [ref=f3e203]
              - generic [ref=f3e204]:
                - generic [ref=f3e206]:
                  - generic [ref=f3e207]: Driver's License Number
                  - textbox [ref=f3e210]
                - generic [ref=f3e212]:
                  - generic [ref=f3e213]: License Expiry Date
                  - generic [ref=f3e217]:
                    - textbox "yyyy-dd-mm" [ref=f3e218]
                    - generic [ref=f3e219] [cursor=pointer]: 
            - separator [ref=f3e220]
            - generic [ref=f3e221]:
              - generic [ref=f3e222]:
                - generic [ref=f3e224]:
                  - generic [ref=f3e225]: Nationality
                  - generic [ref=f3e229] [cursor=pointer]:
                    - generic [ref=f3e230]: "-- Select --"
                    - generic [ref=f3e231]: 
                - generic [ref=f3e234]:
                  - generic [ref=f3e235]: Marital Status
                  - generic [ref=f3e239] [cursor=pointer]:
                    - generic [ref=f3e240]: "-- Select --"
                    - generic [ref=f3e241]: 
              - generic [ref=f3e243]:
                - generic [ref=f3e245]:
                  - generic [ref=f3e246]: Date of Birth
                  - generic [ref=f3e250]:
                    - textbox "yyyy-dd-mm" [ref=f3e251]
                    - generic [ref=f3e252] [cursor=pointer]: 
                - generic [ref=f3e254]:
                  - generic [ref=f3e255]: Gender
                  - generic [ref=f3e257]:
                    - generic [ref=f3e261] [cursor=pointer]:
                      - radio "Male" [ref=f3e262]
                      - text: Male
                    - generic [ref=f3e267] [cursor=pointer]:
                      - radio "Female" [ref=f3e268]
                      - text: Female
            - separator [ref=f3e270]
            - generic [ref=f3e271]:
              - paragraph [ref=f3e272]: "* Required"
              - button "Save" [ref=f3e273] [cursor=pointer]
        - generic [ref=f3e274]:
          - separator [ref=f3e275]
          - generic [ref=f3e277]:
            - heading "Attachments" [level=6] [ref=f3e278]
            - button " Add" [ref=f3e279] [cursor=pointer]:
              - generic [ref=f3e280]: 
              - text: Add
          - table [ref=f3e282]
    - generic [ref=f3e286]:
      - paragraph [ref=f3e287]: OrangeHRM OS 5.9
      - paragraph [ref=f3e288]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f3e289] [cursor=pointer]:
