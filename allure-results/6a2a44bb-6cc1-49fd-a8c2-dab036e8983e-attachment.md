...
- generic [ref=f3e3]:
  ...
  - generic [ref=f3e135]:
    - generic [ref=f3e139]:
      ...
      - generic [ref=f3e168]:
        ...
        - generic [ref=f3e218]:
          ...
          - generic [ref=f3e220]: (13) Records Found
        - table [ref=f3e223]:
          - rowgroup [ref=f3e224]:
            - row [ref=f3e225]:
        ...
        - generic [ref=f3e498]:
          - separator [ref=f3e499]
          - generic [ref=f3e501]:
            - heading "Attachments" [level=6] [ref=f3e502]
            - button " Add" [ref=f3e503] [cursor=pointer]:
              - generic [ref=f3e504]: 
              - text: Add
          - generic [ref=f3e505]:
            - separator [ref=f3e506]
            - generic [ref=f3e507]: (1) Record Found
          - table [ref=f3e510]:
            - rowgroup [ref=f3e511]:
              - row [ref=f3e512]:
                - columnheader "" [ref=f3e513]:
                  - generic [ref=f3e515] [cursor=pointer]:
                    - checkbox "" [ref=f3e516]
                    - generic [ref=f3e517]: 
                - columnheader "File Name" [ref=f3e519]
                - columnheader "Description" [ref=f3e520]
                - columnheader "Size" [ref=f3e521]
                - columnheader "Type" [ref=f3e522]
                - columnheader "Date Added" [ref=f3e523]
                - columnheader "Added By" [ref=f3e524]
                - columnheader "Actions" [ref=f3e525]
            - rowgroup [ref=f3e526]:
              - row [ref=f3e528]:
                - cell "" [ref=f3e529]:
                  - generic [ref=f3e532] [cursor=pointer]:
                    - checkbox "" [ref=f3e533]
                    - generic [ref=f3e534]: 
                - cell "Samplefileupload.rtf" [ref=f3e536]
                - cell [ref=f3e538]
                - cell "381.00 B" [ref=f3e539]
                - cell "text/rtf" [ref=f3e541]
                - cell "2026-19-09" [ref=f3e543]
                - cell "Admin" [ref=f3e545]
                - cell [ref=f3e547]:
                  - generic [ref=f3e548]:
    ...
    - generic [ref=f3e555]:
      - paragraph [ref=f3e556]: OrangeHRM OS 5.9
      - paragraph [ref=f3e557]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f3e558] [cursor=pointer]:
