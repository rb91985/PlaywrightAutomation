...
- Name: handsonExercise/tc02login.spec.ts >> Verify that the employee name can be updated successfully. 
...
- generic [ref=f2e3]:
  ...
  - generic [ref=f2e135]:
    - generic [ref=f2e139]:
      - generic [ref=f2e140]:
        - generic [ref=f2e141]:
          - heading "manda user" [level=6] [ref=f2e143]
        ...
        - generic [ref=f2e169]:
          ...
          - generic [ref=f2e172]:
            - generic [ref=f2e176]:
              ...
              - generic [ref=f2e179]:
                - textbox "First Name" [ref=f2e182]: manda
                - textbox "Middle Name" [ref=f2e185]: akhil
                ...
                - generic [ref=f2e254]:
                  ...
                  - generic [ref=f2e257]:
                    - generic [ref=f2e261] [cursor=pointer]:
                      - radio "Male" [checked] [ref=f2e262]
                      - text: Male
                    - generic [ref=f2e267] [cursor=pointer]:
                      - radio "Female" [ref=f2e268]
                      - text: Female
            - separator [ref=f2e270]
            - generic [ref=f2e271]:
              - paragraph [ref=f2e272]: "* Required"
              - button "Save" [ref=f2e273] [cursor=pointer]
        - generic [ref=f2e274]:
...
```ts
  ...
  8  | 
  9  | test ('Verify that the employee name can be updated successfully. ', async({page}) => {
...
> 15 | await page.click('a[href="/web/index.php/pim/viewDependents"]'); // Click on "Dependents" subtab
     |            ^ Error: page.click: Test timeout of 30000ms exceeded.
