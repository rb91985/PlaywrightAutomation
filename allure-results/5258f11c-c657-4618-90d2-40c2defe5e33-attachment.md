...
Call log:
  - waiting for locator('.orangehrm-edit-employee-name button[type="submit"]')
        ...
        - generic [ref=f2e169]:
          ...
          - generic [ref=f2e172]:
            - generic [ref=f2e176]:
              ...
              - generic [ref=f2e179]:
                - textbox "First Name" [ref=f2e182]: NewName
                - textbox "Middle Name" [active] [ref=f2e185]: NewMiddleName
...
> 21 | await page.locator('.orangehrm-edit-employee-name button[type="submit"]').click(); // Click "Save"
     |                                                                           ^ Error: locator.click: Test timeout of 30000ms exceeded.
